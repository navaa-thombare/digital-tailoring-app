...
class UserRepository extends DatabaseDao {
  ...
  Future<String> createStoreAdmin({
    ...
    final adminRoleRows = await database.query(
      'roles',
      columns: ['id'],
      where: 'code = ?',
      whereArgs: ['admin'],
    ...
    final adminRoleId = adminRoleRows.first['id'] as String;
    ...
    await database.transaction((txn) async {
      ...
      await txn.insert('audit_logs', {
        ...
        'action_type': 'STORE_ADMIN_CREATED',
        'entity_type': 'users',
        'entity_id': userId,
